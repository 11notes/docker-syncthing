...
* [2.0.5](https://hub.docker.com/r/11notes/syncthing/tags?name=2.0.5)
...
# REGISTRIES ☁️
```
docker pull 11notes/syncthing:2.0.5
docker pull ghcr.io/11notes/syncthing:2.0.5
docker pull quay.io/11notes/syncthing:2.0.5
```
...
*created 03.09.2025, 07:26:58 (CET)*